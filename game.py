...
class game(players.player):
  ...
  def keep_card(self):  
    ...
    if game.winner(self):
      ...
      self.leave_card(input("You can't take more cards and have to leave one: "), False)
      return game.winner(self)
    else:
      print(self.start_game(game.displayed_card, True))
      return self.leave_card(input("You can't take more cards and have to leave one: "), False)
